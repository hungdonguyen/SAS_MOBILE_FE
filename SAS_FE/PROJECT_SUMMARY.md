...
### A. Tầng Dịch Vụ API & Quản Lý Phiên (`src/services/` & `src/types/`)
...
### B. Bộ Màn Hình Sinh Viên (`src/screens/Student/`)
...
### C. Điều Hướng & Đăng Nhập (`src/navigation/` & `src/screens/Login/`)
| Tệp tin | Vai trò |
| :--- | :--- |
